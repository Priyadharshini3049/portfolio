...
function java() {
    ...
    tag.innerHTML = '<div class="project-card"> <h3 class="project-title">CodeAiD</h3> <a href="https://github.com/mathavans628/CodeVision.git"> <img src="codeAiD.png"  class="project-img"> </a> </div> <div class="project-card"> <h3 class="project-title">DoublyLinkedList</h3> <a href="https://github.com/Priyadharshini3049/DoublyLinkedList"> <img src="https://media.geeksforgeeks.org/wp-content/uploads/20240318174216/Doubly-Linked-List-in-Data-Structure.webp" class="project-img"> </a> </div><div class="project-card"> <h3 class="project-title">Library Management System</h3> <a href="https://github.com/Priyadharshini3049/My-Portfolio-Projects"> <img src="https://www.skoolbeep.com/blog/wp-content/uploads/2020/12/WHAT-IS-THE-PURPOSE-OF-A-LIBRARY-MANAGEMENT-SYSTEM-min.png" class="project-img"> </a> </div>'
}
